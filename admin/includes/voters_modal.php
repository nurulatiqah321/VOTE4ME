        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="voters_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_vname" class="col-sm-3 control-label">Name</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_vname" name="vname">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_matricno" name="matricno">
                    </div>
                </div>
                <div class="form-group">
