        ...
        <div class="modal-content"> 
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="admin_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label for="roles" class="col-sm-3 control-label">Choose a roles: </label>
                  <div class="col-sm-9">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="admin_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_roles" class="col-sm-3 control-label">Roles</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_roles" name="roles">
                    </div>
                </div>
                <div class="form-group">
